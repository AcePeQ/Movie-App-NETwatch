...
namespace inzynierka_movie_app.Server.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public async Task<IActionResult> GetMovie(string id)
        {
            ...
            var resMovieVideos = await httpService.CreateRequest($"https://api.themoviedb.org/3/movie/{id}/videos?language=en-US");
            ...
            return Json(new {movie = processedResponseMovie, credits = processedResponseCredits, videos = processedResponseVideos});
        }
        ...
        public async Task<IActionResult> GetTVSeries(string id)
        {
            ...
            return Json(new {tvseries = processedResponseTVSeries, credits = processedResponseCredits, videos = processedResponseVideos});
        }
